  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-b from-ivory to-white">
      ...
      <div className="container mx-auto px-4 z-10">
        ...
        >
          <span className="inline-block px-4 py-1 mb-6 text-sm font-medium rounded-full bg-terracotta/10 text-terracotta animate-fade-in">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <button className="px-8 py-3 rounded-lg bg-terracotta text-white font-medium transform transition-all hover:scale-105 hover:shadow-lg">
              I'm a Store Owner
            </button>
            <button className="px-8 py-3 rounded-lg bg-sand text-white font-medium transform transition-all hover:scale-105 hover:shadow-lg">
              I'm a Brand Owner
            </button>
          </div>
        </motion.div>
